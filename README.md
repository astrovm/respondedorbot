...
An AI-powered Telegram bot that plays the role of "el gordo", a politically incorrect Argentine character inspired by the classic "[historical bot personality removed]" and "viejo inimputable" memes. He's blunt, unfiltered, and answers everything in a single lowercase phrase using Argentine slang. Think of him as the guy at the ciber who spent too long on Taringa and the deep web.
