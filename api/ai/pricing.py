...
# Reasoning models count hidden reasoning against this budget. A 1,024-token
# ceiling can therefore expire before they produce a useful visible answer.
CHAT_OUTPUT_TOKEN_LIMIT = 8192
