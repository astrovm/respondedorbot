...
pub fn render_help_page(
    ...
    let entries = [
        ...
        (
            ...
            "/tarea — view and cancel your tasks\n\nExamples\n/tarea tomorrow at 9 remind me to pay rent\n/tarea every Monday at 8 send the dollar rate\n/tarea every 2 hours remind me to drink water",
        ),
        (
            "credits",
            "💳 Créditos",
