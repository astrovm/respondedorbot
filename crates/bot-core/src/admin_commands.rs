...
use crate::credit_units::{
    CreditUnits, format_credit_units, format_credit_units_for, parse_credit_units,
};
    ...
    fn renders_detailed_spanish_creditlog_with_python_parity() {
        let entry = CreditLogEntry {
            ...
            metadata: json!({
                ...
                "raw_usd_micros": 390,
                "model_breakdown": [
                    {"model":"deepseek/deepseek-v4.1-flash","usd_micros":325,"input_cached_tokens":800},
                    {"model":"deepseek/deepseek-v4.1-flash","usd_micros":65,"input_cached_tokens":100}
                ],
                "tool_breakdown": [
