...
| Telegram Stars pre-checkout identity, pack, amount, currency, and invoice-owner validation | `rust-flagged` | `RUST_TELEGRAM_PAYMENTS_ENABLED=0`, missing bridge, bridge error, or invalid bridge result | `contracts/telegram_payments.json` |
