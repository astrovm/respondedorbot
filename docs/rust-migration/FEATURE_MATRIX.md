...
| PostgreSQL idempotent AI provider-usage segments | `rust-flagged` | `RUST_BILLING_PROVIDER_USAGE_ENABLED=0` or missing bridge | `contracts/billing_provider_usage.json` |
